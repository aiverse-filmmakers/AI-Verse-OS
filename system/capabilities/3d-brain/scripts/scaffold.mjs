...
if(!input) throw new Error('Usage: node scaffold.mjs --root <AI-Verse OS folder> --config <JSON file> [--out <new app folder>]');
const out=path.resolve(root,value('--out')||'apps/3d-brain');
if(!out.startsWith(root+path.sep)) throw new Error('Output must be a new folder inside the chosen AI-Verse OS.');
